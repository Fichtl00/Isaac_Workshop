...
class RMPFlowController(mg.MotionPolicyController):
    def __init__(self, name: str, robot_articulation: SingleArticulation, physics_dt: float = 1.0 / 60.0) -> None:
        self.rmpflow = mg.lula.motion_policies.RmpFlow(
            ...
            rmpflow_config_path=os.path.join(os.path.dirname(__file__), "../rmpflow/iisy11_rmpflow_common.yaml"),
            urdf_path=os.path.join(os.path.dirname(__file__), "../rmpflow/lbr_iisy11_1300_robotiq_140.urdf"),
